<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjouterUtilisateur.aspx.cs" Inherits="Flotte.AjouterUtilisateur" %>
      ...
      <a href="ModificationMotDePasse.aspx">Modifier mot de passe</a>
        ...
        <fieldset>
           ...
           <p>
            ...
            <asp:Label ID="Erreurcode" runat="server" ForeColor="Red"></asp:Label>
           </p>
          ...
          <p>
            ...
            <asp:Label ID="Erreurlogin" runat="server" ForeColor="Red"></asp:Label>
             </p>
          
           <p>
            <asp:Label ID="Label7" runat="server" Text="Mot De Passe :"></asp:Label>
            <asp:TextBox ID="mdp" runat="server"></asp:TextBox>
            <asp:Label ID="Erreurmdp" runat="server" ForeColor="Red"></asp:Label>
           </p>
                 ...
                 <p>
                     <asp:Label ID="Label9" runat="server" Text="Role :"></asp:Label>
                         <asp:DropDownList ID="role" runat="server">
                             ...
                             <asp:ListItem Selected="True">Choisir un role</asp:ListItem>
                         </asp:DropDownList>
                     <asp:Label ID="Erreurrole" runat="server" ForeColor="Red"></asp:Label>
                 </p>
          <p>
