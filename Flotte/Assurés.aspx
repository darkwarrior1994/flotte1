<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assurés.aspx.cs" Inherits="Flotte.Assures" %>
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <p>
            &nbsp;</p>
        <div>
            <asp:GridView ID="ListeAssuré" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="CIN"
  ...
  <Columns>
     ...
     <ItemTemplate>
     <asp:Label Text='<%# Eval("CIN") %>' runat="server" />
     </ItemTemplate>
     <EditItemTemplate>
     <asp:TextBox ID="cin" Text='<%# Eval("CIN") %>' runat="server" />
     </EditItemTemplate>
     </asp:TemplateField>
         ...
         <asp:TextBox ID="nom" Text='<%# Eval("Nom") %>' runat="server" />
             ...
             <asp:TextBox ID="prenom" Text='<%# Eval("Prenom") %>' runat="server" />
                     ...
                     <asp:TemplateField HeaderText="Code Postal ">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="codepastal" Text='<%# Eval("CodePostal") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
