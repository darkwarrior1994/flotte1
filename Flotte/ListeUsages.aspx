<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListeUsages.aspx.cs" Inherits="Flotte.ListeUsages" %>
<!DOCTYPE html>
<html>
<head>
    <title></title>
    ...
    <div class="dropdown-content">
      ...
      <a href="ModificationMotDePasse.aspx">Modifier mot de passe</a>
        ...
        <div>
            ...
            <asp:GridView ID="ListeUsage" runat="server" AutoGenerateColumns="false"  DataKeyNames="LibelleUsage"
                ShowHeaderWhenEmpty="true"
              
              OnRowDeleting="ListeUsage_RowDeleting"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="IdUsage">
                        <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="Libelle">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("LibelleUsage") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="libelle" Text='<%# Eval("LibelleUsage") %>' runat="server" />
                        </EditItemTemplate>
