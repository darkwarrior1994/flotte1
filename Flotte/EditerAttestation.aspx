<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditerAttestation.aspx.cs" Inherits="Flotte.Attestation" %>
...
<div class="navbar">
      ...
      <a href="ModificationMotDePasse.aspx">Modifier mot de passe</a>
        ...
        <fieldset>
            <p>
                ...
                <asp:Label ID="Label1" runat="server" Text="Numéro plaque d'immatriculation :"></asp:Label>
                <asp:DropDownList ID="Numimmat" runat="server">
                </asp:DropDownList>
                <asp:Label ID="Erreurnumimmat" runat="server" ForeColor="Red"></asp:Label>

             </p>
        <p>

            <asp:Label ID="Label2" runat="server" Text="Type Attestation :"></asp:Label>
            <asp:DropDownList ID="Typeattestation" runat="server">
                <asp:ListItem>Nouvelle</asp:ListItem>
                <asp:ListItem>Duplicata</asp:ListItem>
                <asp:ListItem>Terme</asp:ListItem>
            </asp:DropDownList>
  ...
  <asp:Label ID="SuccesAjout" runat="server" ForeColor="Green"></asp:Label>
            ...
            <asp:Button ID="Button2" runat="server" OnClick="ajouter" Text="Ajouter" />
